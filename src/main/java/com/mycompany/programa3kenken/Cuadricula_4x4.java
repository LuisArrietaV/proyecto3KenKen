...
/**
 * Clase llamada Cuadricula_4x4, utilizada para generar el juego del tablero del kenken 4x4, 
 * implementando la funcion crearCuadriculaKenken de la interfaz Cuadricula, al tener una asociacion
 * @author Luis Arrieta
 */
public class Cuadricula_4x4 implements Cuadricula{
    
    /**
     * Funcion que genera el juego del Kenken 4x4 según por el tipo de dificultad seleccionada,
