...
/**
 * Clase llamada Cuadricula_6x6, utilizada para generar el juego del tablero del kenken 6x6, 
 * implementando la funcion crearCuadriculaKenken de la interfaz Cuadricula, al tener una asociacion
 * @author Luis Arrieta
 */
public class Cuadricula_6x6 implements Cuadricula{
    
    
    /**
     * Funcion que genera el juego del Kenken 6x6 según por el tipo de dificultad seleccionada,
